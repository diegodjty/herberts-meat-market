      ...
      <div className="main">
        <div className="text">
          ...
          <p>
            ...
            the same quality you've come to know and love for over 80 years.
          </p>
        </div>
        ...
        <div className="specials-container">
          ...
          <div className="special">
            ...
            <div className="price">$155.98</div>
            <div className="list">
              <p>Includes FREE 1 Dozen Extra Large Eggs</p>
              <ul>
          ...
          <div className="special">
            ...
            <div className="price">$145.98</div>
            <div className="list">
              <p>
                IncluIncludes FREE Package of Franks (Chicken, Turkey or Beef)
              </p>
              <ul>
          ...
          <div className="special">
            ...
            <div className="price">$110.98</div>
            <div className="list">
              <p>Includes FREE 1 lb. Package of Margarine</p>
              <ul>
                <li>2 lbs. Prime Cut Chuck Steak</li>
          ...
          <div className="special">
            ...
            <div className="list">
              ...
              <ul>
                ...
                <li>
                  1 Large Loaf of White Bread or 2 Sleeves Buttermilk Biscuits
                </li>
          ...
          <div className="special">
            ...
            <div className="price">$210.98</div>
            <div className="list">
          ...
          <div className="special">
            ...
            <div className="price">$259.98</div>
            <div className="list">
              <p>Includes FREE 3 lb. All Meat Sausage</p>
              <ul>
